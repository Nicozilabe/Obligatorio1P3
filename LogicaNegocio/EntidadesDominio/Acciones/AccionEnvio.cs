...
namespace LogicaNegocio.EntidadesDominio.Acciones
{
    public class AccionEnvio : Accion
    {
        ...
        public AccionEnvio(TipoAccionEnvio tipoAccion, Envio envio, TipoComentarioEnvio comentarioEnvio, Empleado realizador, FechaAccion fecha):base(realizador, fecha)
        {
